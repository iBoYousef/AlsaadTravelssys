...
import { FaHotel, FaUser, FaCalendar, FaMoneyBillWave, FaSearch, FaFilePdf, FaTimes, FaSort, FaSortAmountDown, FaSortAmountUp } from 'react-icons/fa';
...
export default function HotelBookingsHistory() {
  const { user } = useAuth();
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      setLoading(true);
      try {
        const bookingsRef = collection(db, 'hotelBookings');
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <PageHeader title="سجل حجوزات الفنادق" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white rounded-lg shadow-md p-4">
            <div className="flex items-center justify-between">
              ...
              <FaHotel className="text-3xl text-blue-500" />
            </div>
          </div>
