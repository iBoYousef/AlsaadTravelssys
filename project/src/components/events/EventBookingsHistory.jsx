...
import { FaCalendarAlt, FaUser, FaCalendar, FaMoneyBillWave, FaSearch, FaFilePdf, FaTimes, FaSort, FaSortAmountDown, FaSortAmountUp } from 'react-icons/fa';
...
export default function EventBookingsHistory() {
  const { user } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <PageHeader title="سجل حجوزات الفعاليات" />
