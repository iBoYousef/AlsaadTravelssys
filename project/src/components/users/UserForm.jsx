    ...
    <Container maxW="container.lg" py={5}>
      ...
      <Box as="form" onSubmit={handleSubmit} mt={5} boxShadow="md" borderRadius="lg" overflow="hidden" bg={cardBg} p={4}>
        <Flex align="center" bg={headerBg} py={4} mb={4}>
          <Icon as={FaUser} mr={2} />
          <Heading size="md">{id ? 'تعديل بيانات المستخدم' : 'معلومات المستخدم الجديد'}</Heading>
        </Flex>
          ...
          <FormControl isInvalid={!!errors.name}>
            ...
            <InputGroup>
              ...
              <Input
                ...
                placeholder="أدخل اسم المستخدم الكامل"
                borderRadius="md"
              />
            </InputGroup>
          ...
          <FormControl isInvalid={!!errors.role}>
            ...
            <InputGroup>
              ...
              <Select
                ...
                pl="40px"
              >
                {Object.entries(rolesConfig.roles)
      ...
      {role.title}
        ...
        <Flex justifyContent="space-between" mt={4} pt={4} borderTop="1px" borderColor={borderColor}>
          ...
          <Button
            ...
            rightIcon={<FaSave />}
          >
            {id ? 'تحديث البيانات' : 'إضافة مستخدم'}
          </Button>
        </Flex>
      </Box>
    </Container>
